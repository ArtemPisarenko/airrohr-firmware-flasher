...
set PATH=%LocalAppData%\Programs\Python\Python36\;%LocalAppData%\Programs\Python\Python36\Scripts\;%AppData%\Python\Python36\;%AppData%\Python\Python36\Scripts\;%PATH%
